...
export const manualManifest: ManualManifestEntry[] = [
  {
    ...
    summary: "Defines the reference symbolic ontology and parameter registry.",
  ...
  },
  {
    ...
    summary: "Defines the reference metrics used to evaluate simulation outcomes.",
    sourceType: "reference",
    isLive: false,
  ...
  },
  {
    ...
    file: "part-04-reference-field-guidance.tsx",
    summary: "Provides detailed guidance on the meaning and use of reference fields.",
    sourceType: "reference",
    isLive: false,
  ...
  },
  {
    ...
    summary: "The core TypeScript interfaces used by the simulation engine.",
    sourceType: "reference",
    isLive: false,
  ...
  },
  {
    ...
    file: "part-06-a-reference-implementation-order.tsx",
    summary: "Defines the reference order for implementing simulation components.",
    sourceType: "reference",
    isLive: false,
    keywords: ["implementation", "order", "reference"]
  },
  {
    id: "part-07",
