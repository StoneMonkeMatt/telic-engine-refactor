...
/**
 * Mapping of Compass engine metrics from UI labels to reference keys and descriptions.
 */
export const METRICS_MAPPING: MetricMapping[] = [
  ...
  },
  {
    ...
    referenceName: "adversarialStatus",
