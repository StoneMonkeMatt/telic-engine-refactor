...
/**
 * Divergence register between the reference Compass specification and the current engine implementation (Telos v0.9).
 */
export const currentEngineDivergences: DivergenceEntry[] = [
  {
    id: "div-01",
    topic: "UI Labels vs Reference Names",
    referencePosition: "Parameters should be referred to by their reference keys (alpha, gamma, delta, beta).",
  ...
  },
  {
    ...
    referencePosition: "The reference key for the observer threshold is 'observerThreshold'.",
    currentEnginePosition: "The current engine uses the key 'threshold' for this parameter.",
    divergence: "The current engine uses a generic key ('threshold') instead of the specific reference key ('observerThreshold').",
    severity: "medium",
    relatedSections: ["part-01", "part-09"],
    status: "planned"
  },
  {
    ...
    referencePosition: "The reference alignment check for the V9 engine is Mod97.",
  ...
  },
  {
    ...
    referencePosition: "Compass matching should verify if the sequence content matches the pole's specific symbol set.",
  ...
  },
  {
    ...
    referencePosition: "Bridge function labels (e.g., 'Sustainability_to_Community') should trigger specialized scoring or behavior.",
  ...
  },
  {
    ...
    referencePosition: "The reference run record should be populated directly from the engine's internal data structures.",
    currentEnginePosition: "The export mapping logic is still being refined to ensure all reference fields are correctly populated.",
    divergence: "The current export shape may not yet fully align with the reference CompassRunRecord schema.",
    severity: "medium",
