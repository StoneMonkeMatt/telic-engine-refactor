        ...
        <div className="space-y-4">
          <div className="p-4 bg-amber-500/5 border border-amber-500/20 rounded-xl space-y-2">
            ...
            <p className="text-xs text-amber-200/60 leading-relaxed italic">
              Entries in Part XI are dated implementation notes and migration guidance. They do not override the reference contract defined in Parts I–VIII, and they do not replace the live-engine reference documented in Part IX.
            </p>
          </div>
                    ...
                    <div className="space-y-1">
                      ...
                      {note.notes ? (
                        <div className="space-y-2">
                          ...
                          <p className="italic opacity-40 text-[9px]">This entry is a development note and not a reference schema requirement.</p>
                        </div>
                      ) : (
                        <p className="italic opacity-80 text-[10px]">This entry is a development note and not a reference schema requirement.</p>
                      )}
                    </div>
