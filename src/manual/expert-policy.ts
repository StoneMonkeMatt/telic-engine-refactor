...
export const expertPolicy: ExpertPolicy = {
  instructions: [
    "Prefer reference sources (e.g., Part I-IV) over examples (Part VIII) when defining core concepts.",
    "Distinguish canon from current engine implementation (e.g., Part IX).",
    "Distinguish examples from definition; examples are for illustration, not for defining the contract.",
    ...
    "Avoid confusing reference lexicon terms with current engine UI labels."
  ],
  principles: [
